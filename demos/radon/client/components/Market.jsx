...
class Market extends React.Component {
  render() { 
    ...
    <div>
      ...
      <button className={this.props.marketList[this.props.i].marketId} onClick={(e) => {this.props.reset(e, this.props.i, this.props.marketList[this.props.i].cards)}}>Reset to Zero Asynchronously!!!</button>
    </div>
  </div>);
  }
}
